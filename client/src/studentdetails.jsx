  ...
  return (
    <div className="student-details-container">
      <div className="filter-buttons">
        ...
        <button onClick={() => handleButtonClick('Karthi')} className="trainer-button">Karthi</button>
        <button onClick={() => handleButtonClick('Malathi')} className="trainer-button">Malathi</button>
        <button onClick={() => handleButtonClick('Prathi')} className="trainer-button">Prathiksha</button>
