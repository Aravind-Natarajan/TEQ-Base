...
function StudentRegister() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:3001/studentreg', {
        regno,
        name,
        course,
        slot,
  ...
  const handleRetrieve = async () => {
    try {
      const response = await axios.get(`http://localhost:3001/student/${regno}`);
  ...
  const handleUpdate = async () => {
    try {
      const response = await axios.put('http://localhost:3001/studentreg', {
        regno,
        name,
        course,
        slot,
  ...
  //   try {
  //     const response = await axios.delete(`http://localhost:3001/studentreg/${regno}`);
  //     console.log(response.data);
  //     alert(response.data);
